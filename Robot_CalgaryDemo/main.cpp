...
#define BROKER_URL ".messaging.internetofthings.ibmcloud.com";     
	...
	#define ORG "wkfedz"     						// connect to quickstart.internetofthings.ibmcloud.com/ For a registered connection, replace with your org 
	#define ID "000B958901F8"
	#define AUTH_TOKEN "t@qD9e+7NctKckE-fk"
...
void subscribe_cb(MQTT::MessageData & msgMQTT) {
	...
	else if (strcmp(subbed_msg, "pick up") == 0)
	{	
		megapi.putc('t');
        pc.printf("pick up \r\n");
	} 
